    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.IdentityUsers", t => t.UserFk)
                .Index(t => t.UserFk);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ToDoLists", "StudentId", "dbo.Students");
            ...
            DropForeignKey("dbo.Students", "UserFk", "dbo.IdentityUsers");
            ...
            DropIndex("dbo.ToDoLists", new[] { "StudentId" });
            ...
            DropIndex("dbo.Students", new[] { "UserFk" });
